        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/70 text-sm">
              <li><Link href="#about" className="hover:text-orange transition-colors">À propos</Link></li>
              <li><Link href="#testimonials" className="hover:text-orange transition-colors">Témoignages</Link></li>
              <li><Link href="#events" className="hover:text-orange transition-colors">Événements</Link></li>
              <li><Link href="#register" className="hover:text-orange transition-colors">Inscription</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/70 text-sm">
              <li>contact@2alhb.ci</li>
              <li>Lycée Houphouët-Boigny</li>
