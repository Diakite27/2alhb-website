        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-12">
            ...
            <AnimSection className="lg:col-span-2">
              ...
              <p className="text-body text-gray-500 dark:text-gray-400 leading-relaxed mb-6">
              ...
              {/* WhatsApp contact */}
              <a
                href={`https://wa.me/${info.whatsapp.replace(/[^0-9+]/g, "")}?text=${encodeURIComponent("Bonjour, je souhaite avoir des informations sur l'adhésion à la 2ALHB (Amicale des Anciens du Lycée Houphouët-Boigny de Korhogo). Merci.")}`}
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 p-4 rounded-xl bg-green-600/10 dark:bg-green-600/20 border border-green-600/20 hover:bg-green-600/20 dark:hover:bg-green-600/30 transition-all mb-8 group"
              >
                ...
                <div>
                  <p className="font-semibold text-green-700 dark:text-green-400 text-sm group-hover:text-green-800 transition-colors">
